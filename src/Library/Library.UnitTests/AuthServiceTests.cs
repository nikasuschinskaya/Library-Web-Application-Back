...
//        // Arrange
//        var userName = "Test User";
//        var user = new User(userName, _testEmail, new PasswordHasher().HashPassword(_testPassword));
...
//    {
//        // Arrange
//        var user = new User("Test User", _testEmail, new PasswordHasher().HashPassword(_testPassword));
//        await _context.Users.AddAsync(user);
//        await _context.SaveChangesAsync();
...
//        var user = new User("Test User", _testEmail, new PasswordHasher().HashPassword(_testPassword)) { Id = userId };
//        await _context.Users.AddAsync(user);
//        await _context.SaveChangesAsync();
